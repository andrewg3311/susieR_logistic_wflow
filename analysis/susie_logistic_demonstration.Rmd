...
**Note: When performing this demonstration where the response is normally distributed with mean $Xb$ (i.e. the regular SuSiE regime), we observe a similar phenomenon, just to a slightly lesser extent**
