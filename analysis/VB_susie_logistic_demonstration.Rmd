...
$$
\alpha_j \propto \pi_j exp\Bigg\{\frac{\mu_{1j}^2}{2\sigma_{1j}^2}\Bigg\}
$$

Now, we plug in the results we obtained above by applying the MLE idea to the VB lower-bound:
$$
