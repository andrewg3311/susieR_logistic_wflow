...
```
Upon further inspection, it appears that this is happening due to the data being separable, so the GLM algorithm does not converge and has huge standard errors for the estimates. In this case, I am curious as to what the VB algorithm is doing, since it appears to be working fine.
