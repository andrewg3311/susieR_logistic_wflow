...
varbvs.log.fit = varbvs(as.matrix(GO_membership), NULL, clus_1_membership, family = "binomial")
...
varbvs.lin.fit = varbvs(as.matrix(GO_membership), NULL, clus_1_membership, family = "gaussian")
